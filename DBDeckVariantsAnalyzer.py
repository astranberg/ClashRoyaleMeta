...
def deck_analyzer(battle_type, min_trophies, max_trophies, max_battle_age_hours):
    ...
    workbookname = "DeckAnalyzer-" + battle_type + str(min_trophies) + "-" + str(max_trophies) + 'last' + str(
...
def getCards():
    # Define Tokens
    officialAPIToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..OjtfXFYibIEskSGMm9DOU_YaIVf7sTnPJ-0BOSoinC55t2xwPgn89UWU7sPQHXbNI468NGfvqua8XvatxI5fsg"
...
deck_analyzer('ladder', 5600, 7400, 72)
